...
df = pd.read_excel('C:/Users/aas0041/Desktop/590 Project/model_prediction_data.xlsx')
X = df[['EP_POV150', 'EP_UNEMP', 'EP_HBURD', 'EP_NOHSDP', 'EP_UNINSUR', 'EP_AGE65', 'EP_AGE17', 'EP_DISABL', 'EP_SNGPNT', 'EP_LIMENG', 'EP_MINRTY', 'EP_AFAM', 'EP_HISP', 'EP_MUNIT', 'EP_MOBILE', 'EP_CROWD', 'EP_NOVEH', 'EP_GROUPQ']]
y = df['Overall SVI']
