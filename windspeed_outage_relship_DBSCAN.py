# -*- coding: utf-8 -*-
"""
Created on Sat May  4 07:46:39 2024
...
# Calculate clustering evaluation metrics if valid clusters are found
...
# Print additional information about the dataset and clusters
print(f"\nOriginal number of features: {data_for_clustering.shape[1]}")
...
plt.title('DBSCAN Clusters after PCA reduction (Wind Gust vs Power Outage)')
...
selected_columns = ['MaxCustomersOut', 'CustomerHoursOutTotal', 'Outage Density', 'Wind Gust (kt)', 'Cluster']
